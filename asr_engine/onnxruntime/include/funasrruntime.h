...
// FunTpassInferBuffer(FUNASR_HANDLE handle, FUNASR_HANDLE online_handle, const char* sz_buf, int n_len, 
// std::vector<std::vector<std::string>> &punc_cache, bool input_finished=true, 
